...
# Define new_data with appropriate values for prediction
# This is an example - replace with actual values matching your features
new_data = [X.iloc[0].values.tolist()]  # Using first row as example data
